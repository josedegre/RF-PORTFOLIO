...
lifetime=s:rebuild
result=s:1
treepath=s:1D Results\Materials\Silver\Surface Impedance\Z' (FD - Interpolated)
files=s:Silver_Z_re Frequency Domain.sig
...
result=s:1
treepath=s:1D Results\Materials\Silver\Surface Impedance\Z'' (FD - Interpolated)
files=s:Silver_Z_im Frequency Domain.sig
